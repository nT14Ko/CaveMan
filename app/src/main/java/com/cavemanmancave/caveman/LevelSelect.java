...
public class LevelSelect extends Activity {
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			Intent Menu = new Intent(com.cavemanmancave.caveman.LevelSelect.this, MainActivity.class);
			startActivity(Menu);
			finish();
			return true;
		}
	...
	private void startLevel() {
		Game = new Intent(com.cavemanmancave.caveman.LevelSelect.this, com.cavemanmancave.caveman.GameActivity.class);
