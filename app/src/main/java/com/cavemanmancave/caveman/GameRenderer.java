...
import com.cavemanmancave.caveman.enemies.BasicEnemy;
import com.cavemanmancave.caveman.enemies.JumpingEnemy;
import com.cavemanmancave.caveman.enemies.SimpleEnemy;
import com.cavemanmancave.caveman.hero.Hero;
import com.cavemanmancave.caveman.hero.WeaponHandler;
...
public class GameRenderer implements Renderer {
	...
	private com.cavemanmancave.caveman.LevelFinishImage nextLvl;// Creates a new LevelFinishImage object
	private com.cavemanmancave.caveman.LevelFinishImage gameOver;// Creates a new LevelFinishImage object
	...
	private com.cavemanmancave.caveman.LevelParser lvl;

	// varible to store the current level
	private int level;

	// Creates a new Pipe object
	private com.cavemanmancave.caveman.Pipe pipe;
	...
	public GameRenderer(Context context, int height, int width, int level) {
		...
		rowsize = height / 10;
		this.level = level;
		pipe = com.cavemanmancave.caveman.Pipe.getPipe();
		lvl = new com.cavemanmancave.caveman.LevelParser(context);
		...
		this.nextLvl = new com.cavemanmancave.caveman.LevelFinishImage(R.drawable.next_level, height, width);
		this.gameOver = new com.cavemanmancave.caveman.LevelFinishImage(R.drawable.game_over, height, width);
	...
	private void gameOver() {
		Game = new Intent(((Activity) context), com.cavemanmancave.caveman.LevelSelect.class);
