...
public class GameActivity extends Activity {
	private com.cavemanmancave.caveman.UserInteract userInter;// The Canvas layer of the game
	private com.cavemanmancave.caveman.GameView surface;// The OpenGL ES layer of the game
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		clickSound();
		userInter = new com.cavemanmancave.caveman.UserInteract(this);
		userInter.initActions();
		extras = this.getIntent().getExtras();
		level = extras.getString("level");
		surface = new com.cavemanmancave.caveman.GameView(this, height, width, Integer.parseInt(level));
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			Intent Menu = new Intent(com.cavemanmancave.caveman.GameActivity.this, MainActivity.class);
